...
def read_yaml(filename: str | Path, encoding: str = "utf-8") -> dict[str, Any]:
    ...
    if not isinstance(data, dict):
        raise TypeError(f"Expected a YAML mapping at the top level of '{filename}', got {type(data).__name__!r}.")
    return data
...
def write_yaml(
    ...
    **kwargs: Any,
    ...
    if round_trip:
        ...
        # Add the representer only to this specific handler instance
